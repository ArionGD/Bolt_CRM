...
export const VehicleSubPage: React.FC = () => {
  const { role } = useAuth();
  ...
  const canSeePurchasePrice = role === 'admin' || role === 'superuser';
  ...
  return (
    <div className="space-y-5">
      {/* Top Controls: Search, Filters & Add Stock Trigger */}
      ...
      <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
        {filteredVehicles.length === 0 ? (
          <div className="text-center py-16">
            ...
            <h3 className="text-base font-bold text-slate-800">No Vehicles in Stock</h3>
            <p className="text-xs text-slate-500 mt-1 max-w-sm mx-auto">
              Physical inventory is empty. Click "Add Physical Vehicle" to assign and track chassis VINs atomically.
            </p>
            <button
              onClick={() => setShowAddModal(true)}
